...
class StackingModelTester:
    ...
    def test_model(self, **kwargs):
        ...
        with tf.Session(
            ...
            if not (os.path.isfile("./results/trained_models/" + model_name + ".ckpt.meta")):
                ...
                saver.save(session, "./results/trained_models/" + model_name + '.ckpt') # Saving the trained model

            else:
                saver = tf.train.Saver()
                saver.restore(session, "./results/trained_models/"+ model_name + '.ckpt') # Loading the saved model
